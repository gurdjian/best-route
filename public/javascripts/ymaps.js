(function ymapsInit(e) {
  ...
  (t.modules = new o({
    ...
    fetchBundle: function (e) {
      ...
      (o.src = t.env.bundles.BASE + t.env.bundles[e]),
        o.setAttribute("data-ymaps-api-ns", r),
        o.setAttribute("data-ymaps-api-version", "2.1.79"),
        (o.async = !0);
      var i = t.vow.defer();
      return (
    ...
    t.env.server.params.csp &&
      ...
      t.logger.warning("CSP is not suported in this browser"),
    t.modules.define(
    ...
    t.env.hasValidApiKey ||
      ((t.env.apikey = void 0),
      "undefined" != typeof t.env.hasValidApiKey &&
        console.warn("(Yandex Maps JS API): Invalid API key"));
})(
  {
    vectorVersion: "5.16.2",
    vectorVersionTimestamp: 1632386514902,
    cacheVersion: null,
    type: "production",
    flags: [],
    server: {
    ...
    layers: {
      map: {
        version: "21.09.22-0-b210919103030",
        scaled: true,
      ...
      trf: { version: "1632386580", scaled: true },
      sta: { version: "2021.09.23.03.48-1_21.09.22-0-9534" },
      stv: { version: "2021.09.23.03.48-1_21.09.22-0-9534" },
    ...
    geolocation: {
      ...
      span: { longitude: 1.164423, latitude: 0.878654 },
    },
    token: "05a43d9960d1ae7c8725ee3344bcd84d",
    distribution: {},
    version: "2.1.79",
    majorVersion: "2.1",
    ...
    bundles: {
      panoramas:
        "/release/panoramas-0c185fde5cfe1430e95b277aaa8e9a9977944166.js",
      full: "/release/full-ee53113a645d81222ecb164b335955b69104f320.js",
      BASE: "https://yastatic.net/s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-26/build",
    },
  },
  null
);
